...
4. Run `002_seed.sql`.
5. Restart the Next.js apps.
6. Open `/database` in the user app or admin app to confirm connection.

## How v0.4 works

v0.4 includes two levels of database support:
...
2. **Normalized production-ready tables** for profiles, ads, orders, messages, disputes, assets, networks, fees, notifications, risk, integrations, content, and audit logs.
